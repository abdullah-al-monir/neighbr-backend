...
async function seedArtisans() {
  try {
        ...
        portfolio: [
          {
            ...
            description:
              "Custom 6-seater dining table with matching chairs, made from premium mahogany wood",
            images: [
          ...
          },
          {
            ...
            description:
              "Floor-to-ceiling wardrobe with sliding doors and internal organization",
            images: [
        ...
        portfolio: [
          {
            ...
            description:
              "Heavily embroidered bridal lehenga with intricate beadwork",
            images: [
        ...
        portfolio: [
          {
            ...
            description:
              "Full rewiring of 3-bedroom apartment with modern safety features",
            images: [
    ...
    createdArtisans.forEach((artisan: any, i: number) => {
      const user = createdUsers[i];
      console.log(`${i + 1}. ${artisan.businessName}`);
      console.log(`   Category: ${artisan.category}`);
      console.log(
        `   Location: ${artisan.location.area}, ${artisan.location.district}`
      );
      console.log(`   Email: ${user.email}`);
      console.log(`   Password: Demo@123`);
      console.log(
        `   Rating: ${artisan.rating} (${artisan.reviewCount} reviews)`
      );
      console.log("");
    });
