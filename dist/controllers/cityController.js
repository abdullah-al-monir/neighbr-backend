...
exports.deleteCity = exports.updateCity = exports.createCity = exports.getAreasByDistrict = exports.getDistrictsByDivision = exports.getDivisions = exports.getCitiesByDistrict = exports.getCitiesByDivision = exports.getAllCities = void 0;
const City_1 = __importDefault(require("../models/City"));
// Get all active cities
const getAllCities = async (req, res, next) => {
    try {
        const cities = await City_1.default.find({ isActive: true }).sort({ division: 1, district: 1, area: 1 });
        res.status(200).json({
            success: true,
            data: cities,
        });
...
const updateCity = async (req, res, next) => {
    try {
        ...
        const city = await City_1.default.findByIdAndUpdate(id, updates, { new: true, runValidators: true });
        if (!city) {
            res.status(404).json({
                success: false,
